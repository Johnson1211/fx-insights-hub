  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto py-6">
      <div className="flex items-center justify-between border-b border-elite-border/30 pb-4">
        <h1 className="font-display text-3xl text-white tracking-wider">COPY TRADING</h1>
      ...
      >
        ...
        <div className="space-y-4 max-w-2xl mx-auto">
          <h2 className="font-display text-3xl text-white tracking-wider">AUTO-COPY SYSTEM COMING SOON!!</h2>
